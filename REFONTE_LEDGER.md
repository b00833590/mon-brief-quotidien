...
> **Note du 22/07/2026** : un audit complet (produit/design/frontend/backend/sécurité/infra) a
> été mené ce jour-là. Sa partie sécurité/infra (faille XSS corrigée, favicon/meta/OG,
> `vercel.json`, résilience du workflow GitHub Actions) est documentée dans `CLAUDE.md` — ce
> fichier reste dédié au visuel/UX pour éviter que la même information vive à deux endroits.
